    ...
    public function run(): void
    {
        ...
        $this->insertOrganBuilder(
            data: [
                ...
                'importance' => 3,
                'description' => 'Frekventovaná varhanářská firma konce 19. a začátku 20. století. Kvalitou zpracování však její varhany většinou zaostávají za předními varhanářskými podniky té doby. Firma se podílela na výstavbě Voitových varhan v Obecním domě. V r. 1940 provedla první velkou přestavbu cenných barokních varhan u sv. Jakuba v Praze. Kvůli nekvalitním použitým materiálům a vývoji zvukového ideálu byl pak nástroj znovu přestavován firmami Organa a Rieger-Kloss. Tučkova firma postavila řadu pneumatických nástrojů, nicméně nejlépe zachované velké varhany v kostele sv. Jiljí v Nymburku byly v r. 1899 postaveny ještě s mechanickou tónovou trakturou.',
        ...
        $this->insertOrganBuilder(
            data: [
                ...
                'place_of_birth' => null,
                'place_of_death' => null,
                'active_period' => '17.-18. stol.',     // TODO: zkráceno kvůli vzhledu tabulky
                ...
                'perex' => 'Dílo nejvýznamnější představitele tohoto varhanářského rodu, Abraham Starka, je považováno za vrchol barokního varhanářství u nás.',
            ],
            categories: [
                OrganBuilderCategory::BuiltTo1799,
                OrganBuilderCategory::Baroque,
