@props([
    ...
    'showOrganBuilder' => false, 'showOrganBuilderExactOnly' => false, 'showCaseOrganBuilderExactOnly' => false, 'showSizeInfo' => false, 'showSizeInfoOriginal' => false, 'showDescription' => true, 'showShortPlace' => false,
...
@can('view', $organ)
    ...
    >
        ...
        @endif
        <x-organomania.organ-link-content :$organ :$name :$size :$year :$showOrganBuilder :$showOrganBuilderExactOnly :$showCaseOrganBuilderExactOnly :$showSizeInfo :$showSizeInfoOriginal :$showShortPlace :$isRebuild :$isRenovation :$showIsHistoricalCase />
    </a>
@else
    <x-organomania.organ-link-content :$organ :$name :$size :$year :$showOrganBuilder :$showOrganBuilderExactOnly :$showCaseOrganBuilderExactOnly :$showSizeInfo :$showSizeInfoOriginal :$showShortPlace :$isRebuild :$isRenovation :$showIsHistoricalCase />
@endcan
