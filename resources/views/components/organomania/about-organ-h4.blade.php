@props(['subtitle' => null, 'organBuilderCategory' => null, 'organCategory' => null])
...
<div {{ $attributes->class('d-flex flex-wrap row-gap-3 column-gap-2 align-items-end mb-3') }}>
    ...
    <div>
        ...
        @isset($organCategory)
            <a class="btn btn-sm btn-outline-secondary" href="{{ route('organs.index', ['filterCategories' => [$organCategory->value]]) }}" wire:navigate>
