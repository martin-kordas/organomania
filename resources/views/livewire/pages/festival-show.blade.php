...
<div class="organ-builder-show container">
                ...
                <div class="position-relative d-inline-block">
                    @if ($this->image)
                        <a href="{{ $this->image[0] }}" target="_blank">
                            <img class="organ-img rounded border" src="{{ ThumbnailController::getThumbnailUrl($this->image[0]) }}" @isset($this->image[1]) title="{{ __('Licence obrázku') }}: {{ $this->image[1] }}" @endisset style="max-height: 200px" />
                        </a>
                    @endif
                    @if ($festival->region)
    ...
    <div class="text-end mt-3">
        ...
        &nbsp;
        <a class="btn btn-sm btn-outline-primary"  href="#" data-bs-toggle="modal" data-bs-target="#shareModal" data-share-url="{{ route('festivals.show', $festival->slug) }}">
