                    ...
                    <div class="container">
                        <div class="d-flex flex-wrap justify-content-between align-items-center py-2">
                            <div class="flex-grow-1 flex-xl-grow-0">
                                ...
                                <hr class="d-xl-none" style="margin-top: 8px; margin-bottom: 8px;" />
                            </div>

                            <ul class="nav ms-xl-auto list-unstyled column-gap-2">
                                ...
                                <x-organomania.footer-nav-item href="{{ route('organs.cases') }}" wire:navigate>
                                    {{ __('Skříně') }}
                                </x-organomania.footer-nav-item>
